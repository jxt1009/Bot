...
with open("productinfo.json") as file:
    productinfo = json.load(file)

keywords_category = productinfo['category'].split(",")
keywords_model = productinfo['model'].split(",")
keywords_style = productinfo['style'].split(",")
